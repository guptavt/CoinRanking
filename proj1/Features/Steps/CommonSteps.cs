...
namespace Coinranking.Features.Steps
{
    ...
    public class CommonSteps
    {
        ...
        public void WhenRequestIsExecuted(string method)
        {
            ...
            this.scenarioContext.Set<IRestResponse>(response, "RawResponse");
        }
        ...
        public void ThenFindMatching(string propertyToFilter, string filter)
        {
            ...
            if (filter != null)
            {
                filterValues = filter.Trim().Split(',').ToList();
            }
            if (response != null)
            {
                if (propertyToFilter.Equals("coins"))
                {
                ...
                else if (propertyToFilter.Equals("exchanges"))
                {
